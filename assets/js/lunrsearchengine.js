...
var documents = [{% for page in site.posts %}{
    ...
    "lang": "{{ site.data.languages[page.lang].labe---
layout: null
sitemap: false
---
    ...
    if(term) {
        ...
        if(results.length>0){
            ...
            for (var i = 0; i < results.length; i++) {
                ...
                document.querySelectorAll('#lunrsearchresults ul')[0].innerHTML = document.querySelectorAll('#lunrsearchresults ul')[0].innerHTML + "<li class='lunrsearchresult'><a href='" + url + "'><img class='search-img ' src='" + poster+ "'/><span class='url'>"+ url +"</span></a></li>";
            }
        } else {
    ...
    if(term) {
        ...
        if(results.length>0){
            ...
            for (var i = 0; i < results.length; i++) {
                ...
                var lang = documents[ref]['lang'];
                var body = documents[ref]['body'].substring(0,160)+'...';
                document.querySelectorAll('#lunrsearchresults ul')[0].innerHTML = document.querySelectorAll('#lunrsearchresults ul')[0].innerHTML + "<li class='lunrsearchresult'><a href='" + url + "'><img class='search-img' src='" + poster+ "'/><small><span class='url'>"+ url +"</span></small></a></li>";
            }
        } else {
